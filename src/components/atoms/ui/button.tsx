  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-nlec-orange focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-nlec-orange dark:focus-visible:ring-zinc-300",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-nlec-darkGray/10 text-nlec-darkGray dark:hover:bg-zinc-800 dark:hover:text-zinc-50",
        link: "text-nlec-darkGray underline-offset-4 hover:underline hover:text-nlec-orange dark:text-zinc-50",
        logo: "text-nlec-darkGray text-2xl font-medium hover:bg-nlec-darkGray/10 md:text-3xl xl:text-4xl",
      },
      size: {
        default: "px-4 py-2",
        sm: "p-2",
